...
var GitHubActivity = function() {
            ...
            b = {
                ...
                getMessageFor: function(a) {
                    ...
                    if (c.pull_request) {
                        ...
                        if (a.pullRequestLink = b.renderLink(c.html_url, a.repo.name + "#" + g.number), a.mergeMessage = "", c.pull_request.merged) {
                            c.action = "merged";
                ...
                getOutputFromRequest: function(a, b) {
                    ...
                    return e.open("GET", a, !1), e.onload = function() {
                        return e.status >= 200 && e.status < 400 ? (d = JSON.parse(e.responseText), void(c = b(d))) : !1
                    }, e.onerror = function() {
                        console.log("An error occurred connecting to the url.")
                    }, e.send(), c
                },
        ...
        return a.feed = function(a) {
            if (!a.username || !a.selector) return !1;
            ...
            if ("object" == typeof a.templates)
                for (var i in templates) "string" == typeof a.templates[i] && (templates[i] = a.templates[i]);
            if (c = b.getOutputFromRequest(f, b.getHeaderHTML)) {
                var j;
                j = "undefined" != a.limit ? parseInt(a.limit, 10) : null, c += b.getOutputFromRequest(g, function(a) {
                    return b.getActivityHTML(a, j)
                })
            } else c = Mustache.render(templates.NotFound, {
                username: a.username
            });
            if (d = "#" === e.charAt(0) ? document.getElementById(e.substring(1)) : document.getElementsByClassName(e.substring(1)), d instanceof HTMLCollection)
                for (var k = 0; k < d.length; k++) b.renderStream(c, d[k]);
